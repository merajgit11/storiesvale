...
export default function Top10Stories() {
  ...
  return (
    <section className="py-12 pb-6 bg-white" id="topstoryrated">
      <h2 className="text-xl font-bold text-[#000000] mb-2 px-6 md:px-13">Top 10 Stories</h2>
      ...
      <div className="relative ">
        ...
        >
          {stories.map((story, index) => (
            <div
              key={story.id}
              className="relative mt-2 min-w-[200px] max-w-[200px] bg-[#eff5f3] rounded-xl snap-start shrink-0 transform transition-all duration-300 hover:shadow-lg hover:scale-[1.02]"
            >
              {/* Story Number */}
              <div
  className="absolute left-[-18px] z-[1000001] text-[110px] leading-[89px] font-bold uppercase"
  style={{
    background: "linear-gradient(rgb(210, 210, 210) 0%, rgb(39, 39, 39) 100%)",
